      ...
      intro={
        <>
          <P
            ...
            ur={
              <>
                یہ شرائط اُس وقت لاگو ہوتی ہیں جب آپ ٹکل ایپ کے ذریعے آرڈر کرتے
          ...
          <P
            ...
            ur={
              <>
                ٹکل ایک ڈیلیوری سروس ہے۔ ہم آپ کو سوات کی دکانوں اور ریسٹورنٹس سے
        ...
        <Bullets
          items={[
            ...
            },
            {
              ...
              ur: "ٹکل استعمال کرنے کے لیے آپ کی عمر کم از کم 13 سال ہونی چاہیے۔",
            },
          ]}
        />
      </Section>
