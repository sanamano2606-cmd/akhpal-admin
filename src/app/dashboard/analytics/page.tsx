...
export default function AnalyticsPage() {
  ...
  const fetchAnalytics = async () => {
    try {
      setLoading(true);
      const revenue = await apiClient.getRevenueAnalytics(days, "day") as any;
      const riders = await apiClient.getRiderAnalytics(days) as any;
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <select
            ...
            className="px-3 py-2 border border-slate-200 rounded-lg focus:ring-2 focus:ring-primary-600 outline-none text-sm"
          >
